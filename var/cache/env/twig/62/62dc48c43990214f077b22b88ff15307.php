...
class __TwigTemplate_ac075635168f49f37359d52dc0f48fb0 extends Template
{
    private $source;
    private $macros = [];
...
<a href=\"";
        // line 11
        echo twig_escape_filter($this->env, $this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getPath("app_histoire_p1", ["idHistoire" => twig_get_attribute($this->env, $this->source, (isset($context["histoire"]) || array_key_exists("histoire", $context) ? $context["histoire"] : (function () { throw new RuntimeError('Variable "histoire" does not exist.', 11, $this->source); })()), "id", [], "any", false, false, false, 11)]), "html", null, true);
...
<a href=\"{{path('app_histoire_p1',{idHistoire:histoire.id})}}\">Retour à la première page</a>
...
{%endfor%}
{% endblock %}
", "last-page/last-page.html.twig", "/home/steven/tp2-histoire/templates/last-page/last-page.html.twig");
    }
}
