...
class getDoctrine_Orm_DefaultEntityManagerService extends App_KernelEnvDebugContainer
{
    ...
    {
        if (true === $lazyLoad) {
            return $container->services['doctrine.orm.default_entity_manager'] = $container->createProxy('EntityManagerGhost07d5c27', fn () => \EntityManagerGhost07d5c27::createLazyGhost(fn ($proxy) => self::do($container, $proxy)));
        }
        ...
        $a->setRepositoryFactory(new \Doctrine\Bundle\DoctrineBundle\Repository\ContainerRepositoryFactory(new \Symfony\Component\DependencyInjection\Argument\ServiceLocator($container->getService, [
            'App\\Repository\\HistoireRepository' => ['privates', 'App\\Repository\\HistoireRepository', 'getHistoireRepositoryService', true],
            'App\\Repository\\PageRepository' => ['privates', 'App\\Repository\\PageRepository', 'getPageRepositoryService', true],
        ], [
            'App\\Repository\\HistoireRepository' => '?',
