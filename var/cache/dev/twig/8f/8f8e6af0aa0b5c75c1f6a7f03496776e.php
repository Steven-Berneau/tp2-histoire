...
class __TwigTemplate_af3ab59cb1eac2b75d7ad6c4f466e663 extends Template
{
    private $source;
    private $macros = [];
...
";
        ...
        <li><a href=\"";
            // line 20
            echo twig_escape_filter($this->env, $this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getPath("app_histoire_page", ["id" => (twig_get_attribute($this->env, $this->source, $context["page"], "id", [], "any", false, false, false, 20) - 2)]), "html", null, true);
            echo "\">Page ";
            echo twig_escape_filter($this->env, (twig_get_attribute($this->env, $this->source, $context["page"], "id", [], "any", false, false, false, 20) - 1), "html", null, true);
            echo " : ";
...
";
    ...
    <a href=\"";
        // line 24
        echo $this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getPath("app_histoire_page", ["id" => 2]);
...
";
    ...
    {
        return array (  127 => 24,  124 => 23,  111 => 20,  107 => 18,  103 => 17,  96 => 13,  92 => 12,  88 => 11,  84 => 10,  78 => 7,  73 => 6,  66 => 5,  53 => 3,  36 => 1,);
    }
...
{% block body %}
    <h1>{{ histoire.titre }}</h1>
        <img src=\"{{ asset('images/'~histoire.illustation) }}\"/>
<h2>Informations sur le livre gratuit</h2>
    <ul>
...
{% for page in histoire.pages %}
        ...
        <li><a href=\"{{path('app_histoire_page',{'id':page.id-2}) }}\">Page {{ page.id-1 }} : {{ page.texte }}</a></li>
          
{% endfor %}
</ul>
    <a href=\"{{ path('app_histoire_page',{'id':2}) }}\">Lire la suite</a>
{% endblock %}", "pages/page-01.html.twig", "/home/steven/Template/tp2-histoire/templates/pages/page-01.html.twig");
    }
}
